...
```
  ...
  - [The rest of the script can be seen
    ...
    It requires Ant-Contrib, and will automatically download and use it.
...
above example is decidedly NOT.</i>
  ...
  - Previous version of this page: [Equinox/p2/Ant Tasks/Partial
    Mirroring/Example/Galileo](Equinox/p2/Ant_Tasks/Partial_Mirroring/Example/Galileo "wikilink")

[Category:Releng](Category:Releng "wikilink") [Ant Tasks/Partial
Mirroring](Category:Equinox_p2 "wikilink")