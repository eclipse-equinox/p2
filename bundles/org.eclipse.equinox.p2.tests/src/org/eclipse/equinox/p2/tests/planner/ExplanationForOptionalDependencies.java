...
public class ExplanationForOptionalDependencies extends AbstractProvisioningTest {
	...
	public void testNoProblemWithMissingOptionalDependency() {
		...
		IInstallableUnit emf = createIU("EMF", Version.fromOSGiVersion(new org.osgi.framework.Version("1.0.0")), new IRequiredCapability[] {emfMissing}, null, true);
		...
		assertFalse(plan.getNonInstallableRootIUs().contains(cdt));
