...
public class PatchTestUpdate4 extends AbstractProvisioningTest {
	...
	protected void setUp() throws Exception {
		...
		IRequirement lifeCyclepp1 = MetadataFactory.createRequirement(IInstallableUnit.NAMESPACE_IU_ID, P1, VersionRange.emptyRange, null, false, false, true);
		...
		createTestMetdataRepository(p2Feature, p1, p2, p1b, p2b, pp1, p2Feature20);
