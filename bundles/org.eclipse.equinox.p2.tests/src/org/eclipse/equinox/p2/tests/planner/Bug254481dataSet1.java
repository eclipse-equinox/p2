...
public class Bug254481dataSet1 extends AbstractProvisioningTest {
	...
	protected void setUp() throws Exception {
		...
		repo = getMetadataRepositoryManager().loadRepository(getTestData("test data bug 254481", "testData/bug254481/dataSet1/repo").toURL(), null);
		assertNotNull(repo);
	}

	protected void tearDown() throws Exception {
		getMetadataRepositoryManager().removeRepository(getTestData("test data bug 254481", "testData/bug254481/dataSet1/repo").toURL());
		super.tearDown();
	}
