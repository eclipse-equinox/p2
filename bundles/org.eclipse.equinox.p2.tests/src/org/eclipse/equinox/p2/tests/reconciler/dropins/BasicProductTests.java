...
public class BasicProductTests extends AbstractSharedBundleProductTest {
	...
	public void testAddRemove() throws IOException {
		...
		copy(jar, target);
		String targetURLString = target.toURI().toURL().toExternalForm();
	...
	public void testReplace() throws IOException {
		...
		copy(higherJAR, higherTarget);
		String higherTargetURLString = higherTarget.toURI().toURL().toExternalForm();
		removeBundleFromConfiguration(config, targetURLString);
