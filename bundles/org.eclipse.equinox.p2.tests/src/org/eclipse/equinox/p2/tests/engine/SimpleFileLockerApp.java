...
/**
 * This is a tiny console app used by {@link ProfileRegistryTest}, to simulate
 * an external locking mechanism that is triggered as a new process. This code
 * is invoked via the jar file kept in
 * testData/engineTest/SimpleFileLockerApp.jar, which is generated by exporting
 * this single class as a JAR.
 */
