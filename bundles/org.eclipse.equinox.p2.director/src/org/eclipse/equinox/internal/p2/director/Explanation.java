...
/**
 * Copied from the 3.5.x stream for bug 303936.
 * 
 * @since 1.0.6
 */
public abstract class Explanation implements Comparable {
	...
	public static class PatchedHardRequirement extends Explanation {
		...
		public final RequiredCapability req;
		...
		public PatchedHardRequirement(IInstallableUnit iu, RequiredCapability req, IInstallableUnitPatch patch) {
			this.iu = iu;
			this.req = req;
			this.patch = patch;
		}
	...
	public static class HardRequirement extends Explanation {
		...
		public HardRequirement(IInstallableUnit iu, RequiredCapability req) {
			this.iu = iu;
			this.req = req;
		}
	...
	public static class MissingIU extends Explanation {
		...
		public MissingIU(IInstallableUnit iu, RequiredCapability req) {
			this.iu = iu;
			this.req = req;
		}
